...
unsigned char led2_output;
unsigned char PWM_duty[1];
unsigned char lives;
//flags
unsigned char changed;
unsigned char cycleFinished;
unsigned char checkSuccess;
...
static void init(void) {
    ...
    ANSELAbits.ANSA0 = 1;       // (ANALOG) When input, set RA0 as analog or digital
    TRISAbits.TRISA1 = 1;       //Button3 // RA1 second analog input or digital IO
    ANSELAbits.ANSA1 = 0;       // DIGITAL When input, set RA1 as analog or digital
    TRISAbits.TRISA2 = 1;       //Button2 // RA2 third analog input or digital IO
    ANSELAbits.ANSA2 = 0;       // When input, set RA2 as analog or digital
    TRISAbits.TRISA3 = 1;       //Button1// RA3 fourth analog input or digital IO
    ...
    ANSELBbits.ANSB1 = 0;       // SCK
    TRISBbits.TRISB2 = 0;       // AUDIO
    ANSELBbits.ANSB2 = 0;
    TRISBbits.TRISB3 = 1;       // button8
    ANSELBbits.ANSB3 = 0;
    TRISBbits.TRISB4 = 1;       // button7
    ANSELBbits.ANSB4 = 0;
    TRISBbits.TRISB5 = 1;       // button6
    ANSELBbits.ANSB5 = 0;
    TRISBbits.TRISB6 = 1;       // button5
    TRISBbits.TRISB7 = 1;       // button4
